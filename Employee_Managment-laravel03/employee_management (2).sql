...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2023 at 08:48 PM
...
(28, '2023_02_13_224336_create_teams_table', 8),
(29, '2023_02_14_213308_create_projects__details_table', 8),
(30, '2023_02_14_221815_create_sub__projects__details_table', 8);
...
CREATE TABLE `projects_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `pr_main_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pr_main_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pr_main_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `projects_details` (`id`, `pr_main_title`, `pr_main_description`, `pr_main_image`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(8, 'ABC', 'aSDFGHJ', '1676572531Penguins.jpg', 'SWE264', NULL, '2023-02-16 18:35:31', '2023-02-16 18:35:31');
...
--
-- Table structure for table `sub_projects_details`
--

CREATE TABLE `sub_projects_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
  ...
  `pr_sub_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `teams` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `mbr_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mbr_designation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fcb_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `twr_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lnkd_url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `profile_photo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `updated_by` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `teams` (`id`, `mbr_name`, `mbr_designation`, `fcb_url`, `twr_url`, `lnkd_url`, `profile_photo`, `description`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'Ajeet Kumar', 'Software Developer', 'www.asdfghm.com', 'www.sdsfghjdddf.com', 'www.sadfghj1.com', '1676572216Chrysanthemum.jpg', 'ok testing', 'SWE264', 'SWE264', '2023-02-16 18:30:16', '2023-02-16 18:30:27');
...
--
-- Indexes for table `sub_projects_details`
--
ALTER TABLE `sub_projects_details`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `teams`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `teams_fcb_url_unique` (`fcb_url`),
  ADD UNIQUE KEY `teams_twr_url_unique` (`twr_url`),
  ADD UNIQUE KEY `teams_lnkd_url_unique` (`lnkd_url`);
...
--
-- AUTO_INCREMENT for table `sub_projects_details`
--
ALTER TABLE `sub_projects_details`
