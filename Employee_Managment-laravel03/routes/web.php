...
Route::middleware([IsLoggedIn::class])->group(function () {
    ...
    // Add Teams
        Route::get('/admin/add-team', 'Content\TeamController@create');
        Route::POST('/admin/add-new-team', 'Content\TeamController@store');
        Route::get('/admin/all-team', 'Content\TeamController@index');
        Route::get('/admin/edit-team-{id}', 'Content\TeamController@edit');
        Route::get('/admin/delete-team-{id}', 'Content\TeamController@delete');
        Route::POST('/admin/update-team-{id}', 'Content\TeamController@update');

    // Add Projects Details
        Route::get('/admin/allprojectsdetails', 'Content\ProjectsController@index');
        Route::get('/admin/addprojectsdetails', 'Content\ProjectsController@create');
        Route::POST('/admin/addnewprojectsdetails', 'Content\ProjectsController@store');
        Route::get('/admin/edit-projects-details-{id}', 'Content\ProjectsController@edit');
        Route::get('/admin/delete-projects-details-{id}', 'Content\ProjectsController@delete');
        Route::POST('/admin/update-projects-details-{id}', 'Content\ProjectsController@update');
