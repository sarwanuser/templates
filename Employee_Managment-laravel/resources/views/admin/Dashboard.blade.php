...
@section('content')
    <div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-9">
                        <div class="d-flex align-items-center align-self-start">
                          <h3 class="mb-0">{{$NoOfWorkingEmp}}</h3>
                    ...
                    <h6 class="text-muted font-weight-normal">No. Of Employees</h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card" data-toggle="modal" data-target="#myModal">
                <div class="card">
                  <a href="#" class="custumA" title="View current working Employees">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-9">
                          <div class="d-flex align-items-center align-self-start">
                            <h3 class="mb-0">{{count($CurrentWorkingEmp)}}</h3>
                      ...
                      <h6 class="text-muted font-weight-normal">Current Working Employees</h6>
                    </div>
                  </a>
                </div>
              </div>
            ...
            <!-- <div class="" id="myModal1" role="dialog"> -->
              <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">Current Working Employees Details of - {{date("D, d M Y")}}</h4>
                  ...
                  <div class="modal-body">
                    <table class="table">
                      ...
                      <tbody>
                        @php $x=1; @endphp
                        @foreach($CurrentWorkingEmp as $emp)
                        <tr>
                          <td>{{$x++}}</td>
                          <td>{{$emp->emp_name}}</td>
                          <td>{{$emp->emp_code}}</td>
                          <td>{{date("d-m-Y h:i:s A", strtotime($emp->check_in))}}</td>
                          <td>@if(!empty($emp->check_out)) {{date("d-m-Y h:i:s A", strtotime($emp->check_out))}}  @else - @endif</td>
                          <td>@if(!empty($emp->total_work)) {{$emp->total_work}} Hours @else - @endif</td>
                        </tr>
                        @endforeach
                      </tbody>
                    </table>
