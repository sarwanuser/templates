{{-- @php    dd($WeeklyRating, $employee, $Project); @endphp --}}
<!doctype html>
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  <body>
    <div>
        <form action="/client/send-weekly-rating" method="POST">
        @csrf
                                        ...
                                        <td align='left' style='font-size:0px;padding:0px;word-break:break-word;'>
                                          <table border='0' cellpadding='0' cellspacing='0' style='cellpadding:0;cellspacing:0;color:#000000;font-family:Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;' width='100%'>
                                            <tr>
                                              <td align='center'>
                                                <a href='#'>
                                                  <img align='center' alt='Logo' height='33' padding='5px' src="{{asset('images/brand/logo.png')}}" alt="Company Logo" width='120' />
                                                </a>
                                              </td>
                            ...
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#4d4d4d;font-family:Oxygen, Helvetica neue, sans-serif;font-size:32px;font-weight:700;line-height:37px;text-align:center;'>
                                  Rate For Project - {{$Project->project_name}}
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                                <div style='color:#777777;font-family:Oxygen, Helvetica neue, sans-serif;font-size:18px;line-height:21px;text-align:center;'>
                                    <span>For Employee -:</span>
                                    <span>{{$employee->first_name}} {{$employee->last_name}}({{$employee->emp_code}})</span> 
                                </div>
                              </td>
                            </tr>
                          </table>
                    ...
                    <tr>
                      <td align='center' style='font-size:0px;padding:10px 25px;word-break:break-word;'>
                        <table border='0' cellpadding='0' cellspacing='0' style="cellpadding:0;cellspacing:0;color:#777777;font-family:'Oxygen', 'Helvetica Neue', helvetica, sans-serif;font-size:14px;line-height:21px;table-layout:auto;width:100%;" width='100%'>
                          <tr>
                            <th style='text-align: center; color: #4d4d4d; font-weight: 700; padding-bottom: 5px;' width='50%'>
                                <div>
                                    ...
                                    <input type="hidden" name="empCode" value="{{$employee->emp_code}}">
                                    <input type="hidden" name="weekID"  value="{{$WeeklyRating->id}}">
                          ...
                          <tr>
                            <th style='text-align: center;'>
                                <button class='btn btn-primary' type="submit">Send Rating</button>
                            </th>
                          </tr>
                        </table>
                      </td>
