            ...
            <div class="col-sm-12 col-md-6 col-xl-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="col-form-label">Personal Email:       <label class="valueDyn">{{$employee->personal_email}}</label>  <a href="#"><i class="mdi mdi-table-edit" style="color: red;"></i></a> <input type="email" bd_name="personal_email" id=""><a href="#"><i class="mdi mdi-content-save"></i></a> <br><label class='errorMassage'>&nbsp;</label></p>
                        <p class="col-form-label">Company Email:        <label class="valueDyn">{{$employee->company_email}}</label><br><br></p>
                        <p class="col-form-label">Personal Mobile:      <label class="valueDyn">{{$employee->personal_mobile}}</label> <a href="#"><i class="mdi mdi-table-edit" style="color: red;"></i></a> <input type="text" bd_name="personal_mobile" id=""><a href="#"><i class="mdi mdi-content-save"></i></a> <br><label class='errorMassage'>&nbsp;</label></p>
            ...
            <div class="col-sm-12 col-md-6 col-xl-6 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="col-form-label">Bank Name:            <label class="valueDyn">{{$employee->bank_name}}</label>    <a href="#"><i class="mdi mdi-table-edit" style="color: red;"></i></a> <input type="text" bd_name="bank_name" id=""><a href="#"><i class="mdi mdi-content-save"></i></a> <br><label class='errorMassage'>&nbsp;</label></p>
                        <p class="col-form-label">Acc. No :             <label class="valueDyn">{{$employee->acc_no}}</label>       <a href="#"><i class="mdi mdi-table-edit" style="color: red;"></i></a> <input type="text" bd_name="acc_no" id=""><a href="#"><i class="mdi mdi-content-save"></i></a> <br><label class='errorMassage'>&nbsp;</label></p>
                        <p class="col-form-label">IFSC Code:            <label class="valueDyn">{{$employee->ifsc}}</label>         <a href="#"><i class="mdi mdi-table-edit" style="color: red;"></i></a> <input type="text" bd_name="ifsc" id=""><a href="#"><i class="mdi mdi-content-save"></i></a> <br><label class='errorMassage'>&nbsp;</label></p>
                    </div>
                </div>
            </div>
        </div>
